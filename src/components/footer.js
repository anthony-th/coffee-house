...
const socialIcons = [
  ...
  },
  {
    ...
    svg: `<path d="M17 2H14C12.6739 2 11.4021 2.52678 10.4645 3.46447C9.52678 4.40215 9 5.67392 9 7V10H6V14H9V22H13V14H16L17 10H13V7C13 6.73478 13.1054 6.48043 13.2929 6.29289C13.4804 6.10536 13.7348 6 14 6H17V2Z" stroke="#E1D4C9" stroke-linecap="round" stroke-linejoin="round"/>`
  }
];

socialIcons.forEach(({ href, svg, iconAlt }) => {
  const link = createElement('a', ['social-icon'], '', { href, target: '_blank', rel: 'noreferrer noopener', alt: iconAlt, 'aria-label': iconAlt });
  link.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">${svg}</svg>`;
  socialLinks.append(link);
});

const rightBlock = createElement('div', ['footer-block', 'right-block']);
const rightTitle = createElement('h2', ['right-title'], 'Contact us');
const rightContacts = createElement('div', ['contacts-list']);

const contactItems = [
  {
    href: 'https://www.google.com/maps?q=8558+Green+Rd.,+LA',
    innerHTML: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <p class="address-link">8558 Green Rd.,&nbsp;&nbsp;LA</p>`,
  },
  {
    ...
    innerHTML: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <p class="tel-link">+1 (603) 555-0123</p>`,
  },
  {
    innerHTML: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <p class="time-link">Mon-Sat: 9:00 AM – 23:00 PM</p>`
  }
];

contactItems.forEach(({ href, innerHTML }) => {
  const contactLink = href
    ? createElement('a', ['contacts-link'], '', { href, target: '_blank', rel: 'noreferrer noopener' })
