...
const mobileLinks = createElement('div', ['mobile-links', 'cursor-pointer']);
const linkStore = createElement('a', ['mobile-link'], '', { href: 'https://www.apple.com/app-store/', target: '_blank' });
const storeIcon = createElement('svg', [], `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
...
const storeTextBlock = createElement('div', ['mobile-textblock']);
const storeText1 = createElement('p', ['links-title'], `Available on the`);
const storeText2 = createElement('p', ['links-subtitle'], `App Store`);
const linkGogl = createElement('a', ['mobile-link'], '', { href: 'https://play.google.com/store/games', target: '_blank' });
const goglIcon = createElement('svg', [], `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
...
const goglTextBlock = createElement('div', ['mobile-textblock']);
const goglText1 = createElement('p', ['links-title'], `Available on`);
const goglText2 = createElement('p', ['links-subtitle'], `Google Play`);
const mobileImg = createElement('img', ['mobile-img'], '', { src: './assets/img/mobile-screens.webp', alt: '' });
